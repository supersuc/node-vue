                          ...
                          <ul>
                            <li :class="{active : $route.fullPath == '/'}"><router-link :to="{path: '/'}">首页</router-link></li>
                              ...
                              <li :class="{active : $route.fullPath == ''}">
                                  <router-link :to="{path: '/myHouse'}">我的房子</router-link>
                              </li>
                              ...
                              <span class="el-dropdown-link">
                                业主之家<i class="el-icon-arrow-down el-icon--right"></i>
                              </span>
                              ...
                              <li :class="{active : $route.fullPath == '/'}">
                                  <router-link :to="{path: '/users/messages'}">公告板</router-link>
                              </li>



                              <li :class="{active : $route.fullPath == '/'}">
                                  <router-link :to="{path: '/users/contents'}">投诉建议</router-link>
                              </li>

                              <li :class="{active : $route.fullPath == '/'}">
                                  <router-link :to="{path: '/users/contents'}">维修上报</router-link>
                              </li>
