            ...
            <el-col :span="16">
                <div class="data-statistics">
                    <el-row :gutter="10">
                        ...
                        <el-col :xs="6" :sm="6" :md="6" :lg="6" :xl="6">
                            <StaticPannel icon="fa-users" :num="basicInfo.regUserCount" type="success" text="用户"/>
                        </el-col>
                        <el-col :xs="6" :sm="6" :md="6" :lg="6" :xl="6">
                            <StaticPannel icon="fa-file-text-o" :num="basicInfo.contentCount" type="warning" text="文档总数"/>
                        </el-col>
                        <el-col :xs="6" :sm="6" :md="6" :lg="6" :xl="6">
                            <StaticPannel icon="fa-comments-o" :num="basicInfo.messageCount" type="danger" text="消息总数"/>
                        </el-col>
                    </el-row>
                </div>
